...
constexpr int SECONDS_PER_FILE = 1;

void write_wav_header(std::ofstream& out, int sampleRate, int bitsPerSample, int channels, int dataSize) {
...
int main() {
    ...
    const int bufferSize = bytesPerSec * SECONDS_PER_FILE;
